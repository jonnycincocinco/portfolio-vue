...
new Vue({
  ...
  components: {
    ...
    'slide-1': {
      template: '<div class=scroll-page><h2>Apple</h2><div class=revealer><div class=video-container><video controls loop class=video poster="assets/apple/kids-hour-poster.png"><source src=assets/apple/cmw-kids-hour.mp4 type=video/mp4></video><h3>Today at Apple Video Wall: Kids Hour</h3></div></div><div class=revealer><div class=video-container><video controls loop class=video poster="assets/apple/sketch-walks-poster.png"><source src=assets/apple/cmw-sketch-walks.mp4 type=video/mp4></video><h3>Today at Apple Video Wall: Sketch Walks</h3></div></div><div class=revealer><img src="assets/apple/cmw-lineup-concept.jpg"/><h3>Today at Apple Video Wall: Concept Frame</h3></div><div class=revealer><img src="assets/apple/retail-panel.jpg"/><h3>Today at Apple Retail Panel</h3></div><div class=revealer><img src="assets/apple/retail-panel-situ.jpg"/><h3>Today at Apple Retail Panel (in situ)</h3></div><div class=revealer><div class=video-container><video controls loop class=video poster="assets/apple/cmw-screensaver-poster.png"><source src=assets/apple/cmw-screensaver.mp4 type=video/mp4></video><h3>Today at Apple: Screensaver</h3></div></div><div class=revealer><div class=video-container><video controls loop class=video poster="assets/apple/cmw-social-poster.png"><source src=assets/apple/cmw-social.mp4 type=video/mp4></video><h3>Today at Apple: Social Film</h3></div></div><div class=revealer><div class=video-container><video controls loop class=video poster="assets/apple/cmw-snapchat-poster.png"><source src=assets/apple/cmw-snapchat.mp4 type=video/mp4></video><h3>Today at Apple: Snapchat</h3></div></div><div class=revealer><div class=video-container><video controls loop class=video poster="assets/apple/iphone-x-poster.png"><source src=assets/apple/iphone-x.mp4 type=video/mp4></video><h3>iPhone X Launch Film</h3></div></div><div class=revealer><div class=video-container><video controls loop class=video poster="assets/apple/watch-poster.png"><source src=assets/apple/watch-ui.mp4 type=video/mp4></video><h3>Apple Watch UI Animations</h3></div></div></div><!-- last div --> '
    },
    'slide-2': {
      template: '<div class=scroll-page><h2>Airbnb</h2><div class=revealer><div class=video-container><video controls loop class=video poster="assets/airbnb/collections-poster.png"><source src=assets/airbnb/airbnb-collections.mp4 type=video/mp4></video><h3>Collections: UI demo film</h3></div></div><div class=revealer><div class=video-container><video controls loop class=video poster="assets/airbnb/proto-poster.png"><source src=assets/airbnb/surf-for-a-cause.mp4 type=video/mp4></video><h3>Experiences: Product prototype</h3></div></div><div class=revealer><div class=video-container><video controls loop class=video poster="assets/airbnb/framer-poster.png"><source src=assets/airbnb/framer-screencap.mp4 type=video/mp4></video><h3>Experiences: Product prototype in Framer</h3></div></div></div><!-- last div --> '
    },
    'slide-3': {
