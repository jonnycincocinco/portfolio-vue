...
new Vue({
  ...
  components: {
    ...
    'slide-1': {
      template: '<div class=scroll-page><h2>Apple</h2><div class=revealer><div class=revealer><div class=video-container><video controls loop class=video poster="assets/apple/cmw-screensaver-poster.png"><source src=assets/apple/cmw-screensaver.mp4 type=video/mp4></video><h3>Today at Apple: Screensaver</h3></div></div><div class=revealer><div class=video-container><video controls loop class=video poster="assets/apple/cmw-social-poster.png"><source src=assets/apple/cmw-social.mp4 type=video/mp4></video><h3>Today at Apple: Social Film</h3></div></div><div class=revealer><div class=video-container-snapchat><video controls loop class=video poster="assets/apple/cmw-snapchat-poster.png"><source src=assets/apple/cmw-snapchat.mp4 type=video/mp4></video><h3>Today at Apple: Snapchat</h3></div></div><div class=video-container><iframe width="100%" height="315" src="https://www.youtube.com/embed/vhU7YVjExJY" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe><h3>New store opening: Kyoto, Japan</h3></div></div><div class=revealer><div class=video-container><video controls loop class=video poster="assets/apple/iphone-x-poster.png"><source src=assets/apple/iphone-x.mp4 type=video/mp4></video><h3>iPhone X Launch Film</h3></div></div><div class=revealer><div class=video-container><video controls loop class=video poster="assets/apple/watch-poster.png"><source src=assets/apple/watch-ui.mp4 type=video/mp4></video><h3>Apple Watch UI Animations</h3></div></div></div><!-- last div -->'
    },
    'slide-2': {
